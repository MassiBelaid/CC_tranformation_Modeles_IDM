...
public class ProcessPackageImpl extends EPackageImpl implements ProcessPackage {
	 ...
	 */
	@Override
	public EReference getProcess_Begining() {
	 ...
	 */
	@Override
	public EReference getProcess_CurrentActivity() {
	 ...
	 */
	@Override
	public EAttribute getActivity_Nom() {
	 ...
	 */
	@Override
	public EReference getPseudoState_ReferencedActivity() {
	...
	public void createPackageContents() {
		...
		createEReference(processEClass, PROCESS__BEGINING);
		createEReference(processEClass, PROCESS__CURRENT_ACTIVITY);
		createEReference(processEClass, PROCESS__ACTIVITIES);

		activityEClass = createEClass(ACTIVITY);
		createEAttribute(activityEClass, ACTIVITY__NOM);
		...
		createEReference(pseudoStateEClass, PSEUDO_STATE__REFERENCED_ACTIVITY);
	}
	...
	public void initializePackageContents() {
		...
		initEClass.getESuperTypes().add(this.getPseudoState());

		// Initialize classes, features, and operations; add parameters
		initEClass(processEClass, process.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProcess_End(), this.getEnd(), null, "end", null, 1, 1, process.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_Begining(), this.getInit(), null, "begining", null, 1, 1, process.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_CurrentActivity(), this.getActivity(), null, "currentActivity", null, 0, 1, process.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_Activities(), this.getActivity(), null, "activities", null, 0, -1, process.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(activityEClass, Activity.class, "Activity", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getActivity_Nom(), ecorePackage.getEString(), "nom", null, 0, 1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPseudoState_ReferencedActivity(), this.getActivity(), null, "referencedActivity", null, 1, 1, PseudoState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
